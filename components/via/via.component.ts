...
import {Component, OnInit, Renderer2, ViewChild, ChangeDetectorRef, ElementRef, AfterViewInit, Injectable, ChangeDetectionStrategy} from '@angular/core';
...
export class ViaComponent implements OnInit, AfterViewInit {
  ...
  activeGroup$: Subscription;
	...
	@ViewChild('region_canvas', { static: false }) 
	region_canvas: ElementRef<HTMLCanvasElement>;
